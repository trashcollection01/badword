...
import net.joohnserde.badword.presentation.workspace.compose_component.code
import net.joohnserde.badword.presentation.workspace.compose_component.CodeEditorCompose
import net.joohnserde.badword.domain.workspace.model.CodeEditor
import net.joohnserde.badword.domain.workspace.model.MenuList
import net.joohnserde.badword.presentation.drawer.DrawerMenu
import net.joohnserde.badword.presentation.workspace.compose_component.MainMenuCompose
import net.joohnserde.badword.presentation.workspace.compose_component.PathMenuCompose
import net.joohnserde.badword.presentation.common.reusable.widgets.IconButton24
import net.joohnserde.badword.presentation.common.reusable.widgets.Tabbar
